...
<div class="badge-container">
  ...
  <br>
  Link zum öffentlichen Digital Badge: <a href='https://prompting.schule/badge/{badge.hash}/{user.email}' target="_blank">https://prompting.schule/badge/{badge.hash}/{user.email}</a>
